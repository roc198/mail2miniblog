...
get '/' do
	...
	'<div>邮件收发微博:<br>授权<a href="' + href + '" title="mail2miniblog">邮件发(SINA)微博</a</div><div><a href="http://code.google.com/p/mail2miniblog" target="_blank">本站源码</a></div><div><a href="http://weibo.session.im" target="_blank">分享微博订阅</a></div>'
end
